...
struct AppSemanticFitnessTests {
    ...
    func typedTaskEventConstantsAreCategorizedExplicitly() throws {
        let expectedCategories: [String: TaskEventCategory] = [
            ...
            "error": .system,
            "execution.request.chained": .lifecycle,
            "execution.request.initial": .lifecycle,
            "execution.request.permission_resume": .lifecycle,
            "execution.request.plan_step": .lifecycle,
            "execution.request.resume": .lifecycle,
            "execution.request.retry": .lifecycle,
            "execution.request.scheduled": .lifecycle,
