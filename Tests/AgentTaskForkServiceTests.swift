...
struct AgentTaskForkServiceTests {
    ...
    func gitForkBecomesReadOnlyDuringSharedWorktreeRun() throws {
        ...
        forked.executionRootPath = (root as NSString).appendingPathComponent("packages/api")
        source.executionRootPath = (root as NSString).appendingPathComponent("packages/web")
        ...
        let blocker = TaskForkPolicyService.activeSharedWorktreeBlocker(
            ...
            repositoryRootResolver: { _ in root }
        )
