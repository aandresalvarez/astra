...
struct TaskCapabilityResolverTests {
    private let _registerRuntimeSeams: Void = RuntimeSeamRegistration.registerAll() // TaskCapabilityResolver reads skill.environmentVariables for every live skill, needs SkillSecretSeam
