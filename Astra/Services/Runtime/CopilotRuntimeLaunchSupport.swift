...
enum CopilotLaunchDiagnostics {
    ...
    static func commandPlannedFields(
        ...
        nativeDirectories: ProviderNativeDirectoryProjection.Result,
        ...
        var fields: [String: String] = [
            ...
            "additional_paths_count": String(nativeDirectories.additionalDirectories.count),
            "provider_native_unreachable_read_only_file_count": String(nativeDirectories.unreachableFiles.count),
