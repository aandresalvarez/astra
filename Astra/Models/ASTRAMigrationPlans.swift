...
public enum ASTRAOrphanedV12MigrationPlan: SchemaMigrationPlan {
    public static var schemas: [any VersionedSchema.Type] {
        [ASTRASchemaV12RuntimeOnly.self, ASTRASchemaV13.self, ASTRASchemaV14.self, ASTRASchemaV15.self, ASTRASchemaV16.self, ASTRASchemaV17.self, ASTRASchemaV18.self]
    }
...
public enum ASTRAFeedbackOnlyV12MigrationPlan: SchemaMigrationPlan {
    public static var schemas: [any VersionedSchema.Type] {
        [ASTRASchemaV12FeedbackOnly.self, ASTRASchemaV13.self, ASTRASchemaV14.self, ASTRASchemaV15.self, ASTRASchemaV16.self, ASTRASchemaV17.self, ASTRASchemaV18.self]
    }
