...
struct ShelfMarkdownPanelView: View {
    ...
    @State private var fileNavigatorOrganization = ShelfFileNavigatorOrganization.stored
    ...
    private var fileNavigator: some View {
        VStack(spacing: 0) {
            ShelfFileNavigatorHeader(
                ...
                organization: $fileNavigatorOrganization,
                isPinned: $isFileNavigatorPinned,
            ...
            if let task, fileNavigatorOrganization == .turns {
    ...
    private func openTurnFile(_ path: String) {
        startDocumentLoad(URL(fileURLWithPath: path), automatically: false)
        finishFileSelection()
    }
